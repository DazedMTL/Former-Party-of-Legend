...
Moghunter.ahud_layout2_visible = String(
  Moghunter.parameters["Layout Overlay Visible"] || true
);
Moghunter.ahud_layout2_x = Number(
  Moghunter.parameters["Layout Overlay X-Axis"] || 0
);
Moghunter.ahud_layout2_y = Number(
  Moghunter.parameters["Layout Overlay Y-Axis"] || 0
);

// FACE POSITION
Moghunter.ahud_face_visible = String(
  Moghunter.parameters["Face Visible"] || true
);
Moghunter.ahud_face_shake = String(
  Moghunter.parameters["Face Shake Animation"] || true
);
Moghunter.ahud_face_zoom = String(
  Moghunter.parameters["Face Zoom Animation"] || true
);
Moghunter.ahud_face_animated = String(
...
Moghunter.ahud_face_priority = Number(
  Moghunter.parameters["Face Priority"] || 1
);

// NAME POSITION
Moghunter.ahud_name_visible = String(
  Moghunter.parameters["Name Visible"] || true
);
Moghunter.ahud_name_font_size = Number(
  Moghunter.parameters["Name Font Size"] || 20
);
Moghunter.ahud_name_font_bold_size = Number(
  Moghunter.parameters["Name Bold Size"] || 4
);
Moghunter.ahud_name_font_italic = String(
...
Moghunter.ahud_hp_icon_visible = String(
  Moghunter.parameters["HP Icon Visible"] || "false"
);
Moghunter.ahud_hp_icon_halfMode = String(
  Moghunter.parameters["HP Icon Half Mode"] || "false"
);
...
Moghunter.ahud_hp_icon_pos_x = Number(
  Moghunter.parameters["HP Icon X-Axis"] || 143
);
Moghunter.ahud_hp_icon_pos_y = Number(
  Moghunter.parameters["HP Icon Y-Axis"] || 85
);
...
// MP ICON POSITION
Moghunter.ahud_mp_icon_visible = String(
  Moghunter.parameters["MP Icon Visible"] || "false"
);
Moghunter.ahud_mp_icon_halfMode = String(
  Moghunter.parameters["MP Icon Half Mode"] || "false"
);
Moghunter.ahud_mp_icon_colorMax = Number(
  Moghunter.parameters["MP Icon Max Colors"] || 2
);
Moghunter.ahud_mp_icon_rows = Number(
  Moghunter.parameters["MP Icon Max Rows"] || 10
);
Moghunter.ahud_mp_icon_cols = Number(
  Moghunter.parameters["MP Icon Max Columns"] || 2
);
Moghunter.ahud_mp_icon_pos_x = Number(
  Moghunter.parameters["MP Icon X-Axis"] || 143
);
Moghunter.ahud_mp_icon_pos_y = Number(
  Moghunter.parameters["MP Icon Y-Axis"] || 125
);
Moghunter.ahud_mp_icon_space_x = Number(
  Moghunter.parameters["MP Icon Space X"] || 0
);
Moghunter.ahud_mp_icon_space_y = Number(
  Moghunter.parameters["MP Icon Space Y"] || 0
);
Moghunter.ahud_mp_icon_zoomAnime = String(
  Moghunter.parameters["MP Icon Zoom Anime"] || "true"
);

// TP ICON POSITION
Moghunter.ahud_tp_icon_visible = String(
  Moghunter.parameters["TP Icon Visible"] || "false"
);
Moghunter.ahud_tp_icon_halfMode = String(
  Moghunter.parameters["TP Icon Half Mode"] || "false"
);
Moghunter.ahud_tp_icon_colorMax = Number(
  Moghunter.parameters["TP Icon Max Colors"] || 2
);
Moghunter.ahud_tp_icon_rows = Number(
  Moghunter.parameters["TP Icon Max Rows"] || 10
);
Moghunter.ahud_tp_icon_cols = Number(
  Moghunter.parameters["TP Icon Max Columns"] || 2
);
Moghunter.ahud_tp_icon_pos_x = Number(
  Moghunter.parameters["TP Icon X-Axis"] || 143
);
Moghunter.ahud_tp_icon_pos_y = Number(
  Moghunter.parameters["TP Icon Y-Axis"] || 50
);
Moghunter.ahud_tp_icon_space_x = Number(
  Moghunter.parameters["TP Icon Space X"] || 0
);
Moghunter.ahud_tp_icon_space_y = Number(
  Moghunter.parameters["TP Icon Space Y"] || 0
);
Moghunter.ahud_tp_icon_zoomAnime = String(
  Moghunter.parameters["TP Icon Zoom Anime"] || "true"
);

// HP METER POSITION
Moghunter.ahud_hp_meter_visible = String(
  Moghunter.parameters["HP Meter Visible"] || true
);
Moghunter.ahud_hp_meter_pos_x = Number(
  Moghunter.parameters["HP Meter X-Axis"] || 143
);
Moghunter.ahud_hp_meter_pos_y = Number(
  Moghunter.parameters["HP Meter Y-Axis"] || 85
);
Moghunter.ahud_hp_meter_rotation = Number(
  Moghunter.parameters["HP Meter Angle"] || 0
);
Moghunter.ahud_hp_meter_flow = String(
  Moghunter.parameters["HP Meter Flow Anime"] || true
);
Moghunter.ahud_hp_flowSpd = Number(
  Moghunter.parameters["HP Meter Flow Speed"] || 2
);

// HP NUMBER POSITION
Moghunter.ahud_hp_number_visible = String(
  Moghunter.parameters["HP Number Visible"] || true
);
Moghunter.ahud_hp_number_align = Number(
  Moghunter.parameters["HP Number Align"] || 0
);
Moghunter.ahud_hp_number_pos_x = Number(
  Moghunter.parameters["HP Number X-Axis"] || 270
);
Moghunter.ahud_hp_number_pos_y = Number(
  Moghunter.parameters["HP Number Y-Axis"] || 70
);
Moghunter.ahud_maxhp_number_visible = String(
  Moghunter.parameters["MaxHP Number Visible"] || false
);
Moghunter.ahud_maxhp_number_pos_x = Number(
  Moghunter.parameters["MaxHP Number X-Axis"] || 125
);
Moghunter.ahud_maxhp_number_pos_y = Number(
  Moghunter.parameters["MaxHP Number Y-Axis"] || 13
);

// MP METER POSITION
Moghunter.ahud_mp_meter_visible = String(
  Moghunter.parameters["MP Meter Visible"] || true
);
Moghunter.ahud_mp_meter_pos_x = Number(
  Moghunter.parameters["MP Meter X-Axis"] || 160
);
Moghunter.ahud_mp_meter_pos_y = Number(
  Moghunter.parameters["MP Meter Y-Axis"] || 115
);
Moghunter.ahud_mp_meter_rotation = Number(
  Moghunter.parameters["MP Meter Angle"] || 0
);
Moghunter.ahud_mp_meter_flow = String(
  Moghunter.parameters["MP Meter Flow Anime"] || true
);
Moghunter.ahud_mp_flowSpd = Number(
  Moghunter.parameters["MP Meter Flow Speed"] || 2
);

// MP NUMBER POSITION
Moghunter.ahud_mp_number_visible = String(
  Moghunter.parameters["MP Number Visible"] || true
);
Moghunter.ahud_mp_number_align = Number(
  Moghunter.parameters["MP Number Align"] || 0
);
Moghunter.ahud_mp_number_pos_x = Number(
  Moghunter.parameters["MP Number X-Axis"] || 287
);
Moghunter.ahud_mp_number_pos_y = Number(
  Moghunter.parameters["MP Number Y-Axis"] || 100
);
Moghunter.ahud_maxmp_number_visible = String(
  Moghunter.parameters["MaxMP Number Visible"] || false
);
Moghunter.ahud_maxmp_number_pos_x = Number(
  Moghunter.parameters["MaxMP Number X-Axis"] || 196
);
Moghunter.ahud_maxmp_number_pos_y = Number(
  Moghunter.parameters["MaxMP Number Y-Axis"] || 78
);

// TP METER POSITION
Moghunter.ahud_tp_meter_visible = String(
  Moghunter.parameters["TP Meter Visible"] || true
);
Moghunter.ahud_tp_meter_pos_x = Number(
  Moghunter.parameters["TP Meter X-Axis"] || 143
);
Moghunter.ahud_tp_meter_pos_y = Number(
  Moghunter.parameters["TP Meter Y-Axis"] || 145
);
Moghunter.ahud_tp_meter_rotation = Number(
  Moghunter.parameters["TP Meter Angle"] || 0
);
Moghunter.ahud_tp_meter_flow = String(
  Moghunter.parameters["TP Meter Flow Anime"] || false
);
Moghunter.ahud_tp_flowSpd = Number(
  Moghunter.parameters["TP Meter Flow Speed"] || 2
);

// TP NUMBER POSITION
Moghunter.ahud_tp_number_visible = String(
  Moghunter.parameters["TP Number Visible"] || true
);
Moghunter.ahud_tp_number_align = Number(
  Moghunter.parameters["TP Number Align"] || 0
);
Moghunter.ahud_tp_number_pos_x = Number(
  Moghunter.parameters["TP Number X-Axis"] || 270
);
Moghunter.ahud_tp_number_pos_y = Number(
  Moghunter.parameters["TP Number Y-Axis"] || 130
);
Moghunter.ahud_maxtp_number_visible = String(
  Moghunter.parameters["MaxTP Number Visible"] || false
);
Moghunter.ahud_maxtp_number_pos_x = Number(
  Moghunter.parameters["MaxTP Number X-Axis"] || 185
);
Moghunter.ahud_maxtp_number_pos_y = Number(
  Moghunter.parameters["MaxTP Number Y-Axis"] || 116
);

// Level NUMBER POSITION
Moghunter.ahud_level_number_visible = String(
  Moghunter.parameters["Level Number Visible"] || true
);
Moghunter.ahud_level_number_align = Number(
  Moghunter.parameters["Level Number Align"] || 1
);
Moghunter.ahud_level_number_pos_x = Number(
  Moghunter.parameters["Level Number X-Axis"] || 65
);
Moghunter.ahud_level_number_pos_y = Number(
  Moghunter.parameters["Level Number Y-Axis"] || 153
);

// EXP METER POSITION
Moghunter.ahud_exp_meter_visible = String(
  Moghunter.parameters["EXP Meter Visible"] || true
);
Moghunter.ahud_exp_meter_pos_x = Number(
  Moghunter.parameters["EXP Meter X-Axis"] || 127
);
Moghunter.ahud_exp_meter_pos_y = Number(
  Moghunter.parameters["EXP Meter Y-Axis"] || 173
);
Moghunter.ahud_exp_meter_rotation = Number(
  Moghunter.parameters["EXP Meter Angle"] || 0
);

// STATES POSITION
Moghunter.ahud_states_visible = String(
  Moghunter.parameters["States Visible"] || true
);
Moghunter.ahud_states_pos_x = Number(
  Moghunter.parameters["States X-Axis"] || 5
);
Moghunter.ahud_states_pos_y = Number(
  Moghunter.parameters["States Y-Axis"] || 64
);
...
Game_System.prototype.initialize = function () {
  ...
  this._actorHudData = {};
  this._actorHudData.visible =
    String(Moghunter.ahud_hudvisible) === "true" ? true : false;
  this._ahud_position = [0, 0];
  this._ahud_smartFade =
    String(Moghunter.ahud_smartFade) === "true" ? true : false;
  this._ahud_autoFade =
    String(Moghunter.ahud_autoFade) === "true" ? true : false;
...
Game_Actor.prototype.current_exp_r = function () {
  return (
    this.nextLevelExp() - this.nextRequiredExp() - this.expForLevel(this._level)
  );
};
...
//==============================
var _mog_actorHud_scnMap_snapForBattleBackground =
  Scene_Map.prototype.snapForBattleBackground;
Scene_Map.prototype.snapForBattleBackground = function () {
  if (this._hudField && SceneManager.isNextScene(Scene_Battle)) {
...
Actor_Hud.prototype.load_img = function () {
  ...
  if (String(Moghunter.ahud_layout2_visible) == "true") {
    this._layout2_img = ImageManager.loadAHud("Layout2");
  }
  if (String(Moghunter.ahud_hp_meter_visible) == "true") {
    this._hp_meter_img = ImageManager.loadAHud("HP_Meter");
  }
  if (String(Moghunter.ahud_mp_meter_visible) == "true") {
    this._mp_meter_img = ImageManager.loadAHud("MP_Meter");
  }
  if (String(Moghunter.ahud_tp_meter_visible) == "true") {
    this._tp_meter_img = ImageManager.loadAHud("TP_Meter");
  }
  if (String(Moghunter.ahud_hp_icon_visible) == "true") {
    this._hp_icon_img = ImageManager.loadAHud("HP_Icon");
  }
  if (String(Moghunter.ahud_mp_icon_visible) == "true") {
    this._mp_icon_img = ImageManager.loadAHud("MP_Icon");
  }
  if (String(Moghunter.ahud_tp_icon_visible) == "true") {
    this._tp_icon_img = ImageManager.loadAHud("TP_Icon");
  }
  if (String(Moghunter.ahud_exp_meter_visible) == "true") {
    this._exp_meter_img = ImageManager.loadAHud("EXP_Meter");
  }
  if (String(Moghunter.ahud_hp_number_visible) == "true") {
    this._hp_number_img = ImageManager.loadAHud("HP_Number");
  }
  if (String(Moghunter.ahud_mp_number_visible) == "true") {
    this._mp_number_img = ImageManager.loadAHud("MP_Number");
  }
  if (String(Moghunter.ahud_tp_number_visible) == "true") {
    this._tp_number_img = ImageManager.loadAHud("TP_Number");
  }
  if (String(Moghunter.ahud_level_number_visible) == "true") {
    this._level_number_img = ImageManager.loadAHud("LV_Number");
  }
  if (String(Moghunter.ahud_maxhp_number_visible) == "true") {
    this._maxhp_number_img = ImageManager.loadAHud("HP_Number2");
  }
...
// * Refresh Meter
//==============================
Actor_Hud.prototype.refresh_meter = function (
  sprite,
  value,
  value_max,
  type,
...
// * Refresh Flow
//==============================
Actor_Hud.prototype.refresh_meter_flow = function (
  sprite,
  value,
  value_max,
  type,
...
// * Refresh Number
//==============================
Actor_Hud.prototype.refresh_number = function (
  sprites,
  value,
  img_data,
  x,
...
Actor_Hud.prototype.need_refresh_parameter = function (parameter) {
  switch (parameter) {
    ...
    case 2:
      ...
      break;
    case 3:
      if (this._exp_old != this._battler.currentExp()) {
        return true;
      }
      break;
  }
...
Actor_Hud.prototype.create_face = function () {
  if (String(Moghunter.ahud_face_visible) != "true") {
    return;
  }
  if (this._face) {
  ...
  this._face = new Sprite(
    ImageManager.loadAHud("Face_" + this._battler._actorId)
  );
  this._face.anchor.x = 0.5;
  this._face.anchor.y = 0.5;
  this._face_data = [0, 0, false, false, false, -1];
  if (String(Moghunter.ahud_face_shake) === "true") {
    this._face_data[2] = true;
  }
  if (String(Moghunter.ahud_face_animated) === "true") {
  ...
  if (this._battler._ahud_face_data[3] > 0) {
    ...
    if (this._battler._ahud_face_data[3] === 0) {
      if (this._battler.isDead()) {
        this._battler._ahud_face_data[2] = 4;
      } else if (this._battler.hp <= (30 * this._battler.mhp) / 100) {
        this._battler._ahud_face_data[2] = 3;
      } else {
        this._battler._ahud_face_data[2] = 0;
      }
    }
  }
};
...
Actor_Hud.prototype.update_face_shake = function () {
  ...
  if (this._face_data[2] && this._battler._ahud_face_data[0] > 0) {
    ...
    this._face.x =
      this._pos_x + Moghunter.ahud_face_pos_x + (Math.random() * 12 - 6);
  }
};
...
Actor_Hud.prototype.create_name = function () {
  if (String(Moghunter.ahud_name_visible) != "true") {
    return;
  }
  if (this._name) {
  ...
  if (String(Moghunter.ahud_name_font_italic) === "true") {
...
Actor_Hud.prototype.create_hp_meter = function () {
  ...
  this._hp_meter_red.rotation =
    (Moghunter.ahud_hp_meter_rotation * Math.PI) / 180;
...
Actor_Hud.prototype.create_mp_icon = function () {
  ...
  this._mp_icons = [];
  this._mp_icons.iconMode =
    String(Moghunter.ahud_mp_icon_halfMode) == "true" ? true : false;
  this._mp_iconsB = [];
  this._mp_iconsB.iconMode = 0;
  this._mp_IconZoomAnime =
    String(Moghunter.ahud_mp_icon_zoomAnime) == "true" ? true : false;
  ...
  for (var i = 0; i < n_icons; i++) {
    ...
    this._mp_iconsB[i].org = [
      this._pos_x + Moghunter.ahud_mp_icon_pos_x - cw,
      this._pos_y + Moghunter.ahud_mp_icon_pos_y - ch,
    ];
    this._mp_iconsB[i].spc = [
      Moghunter.ahud_mp_icon_space_x,
      Moghunter.ahud_mp_icon_space_y,
    ];
    this._mp_iconsB[i].zoomA = this._mp_IconZoomAnime;
    this._mp_iconsB[i].zoomData = [0, 0, 0, 1.0];
  ...
  for (var i = 0; i < n_icons; i++) {
    ...
    this._mp_icons[i].org = [
      this._pos_x + Moghunter.ahud_mp_icon_pos_x - cw,
      this._pos_y + Moghunter.ahud_mp_icon_pos_y - ch,
    ];
    this._mp_icons[i].spc = [
      Moghunter.ahud_mp_icon_space_x,
      Moghunter.ahud_mp_icon_space_y,
    ];
    this._mp_icons[i].zoomA = this._mp_IconZoomAnime;
    this._mp_icons[i].zoomData = [0, 0, 0, 1.0];
...
Actor_Hud.prototype.create_tp_icon = function () {
  ...
  this._tp_icons = [];
  this._tp_icons.iconMode =
    String(Moghunter.ahud_tp_icon_halfMode) == "true" ? true : false;
  this._tp_iconsB = [];
  this._tp_iconsB.iconMode = this._tp_icons.iconMode;
  this._tp_IconZoomAnime =
    String(Moghunter.ahud_tp_icon_zoomAnime) == "true" ? true : false;
  ...
  for (var i = 0; i < n_icons; i++) {
    ...
    this._tp_iconsB[i].org = [
      this._pos_x + Moghunter.ahud_tp_icon_pos_x - cw,
      this._pos_y + Moghunter.ahud_tp_icon_pos_y - ch,
    ];
    this._tp_iconsB[i].spc = [
      Moghunter.ahud_tp_icon_space_x,
      Moghunter.ahud_tp_icon_space_y,
    ];
    this._tp_iconsB[i].zoomA = this._tp_IconZoomAnime;
    this._tp_iconsB[i].zoomData = [0, 0, 0, 1.0];
  ...
  for (var i = 0; i < n_icons; i++) {
    ...
    this._tp_icons[i].org = [
      this._pos_x + Moghunter.ahud_tp_icon_pos_x - cw,
      this._pos_y + Moghunter.ahud_tp_icon_pos_y - ch,
    ];
    this._tp_icons[i].spc = [
      Moghunter.ahud_tp_icon_space_x,
      Moghunter.ahud_tp_icon_space_y,
    ];
    this._tp_icons[i].zoomA = this._tp_IconZoomAnime;
    this._tp_icons[i].zoomData = [0, 0, 0, 1.0];
...
// * is Icon Visible
//==============================
Actor_Hud.prototype.isIconVisible = function (
  i,
  mode,
  par,
  par_max,
...
// * set Color Index
//==============================
Actor_Hud.prototype.setColorIndex = function (
  i,
  mode,
  par,
  par_max,
...
// * is Icon Enabled
//==============================
Actor_Hud.prototype.isIconEnabled = function (
  i,
  mode,
  par,
  par_max,
...
//==============================
Actor_Hud.prototype.refreshIconNormalMode = function (
  sprites,
  image,
  par,
  par_max,
...
//==============================
Actor_Hud.prototype.refreshIconHalfMode = function (
  sprites,
  image,
  par,
  par_max,
...
Actor_Hud.prototype.update_hp = function () {
  if (this._hp_meter_blue) {
    if (this._hp_flow[0]) {
      ...
      if ($gameSystem._ahud_flowData[0] > this._hp_flow[3]) {
        $gameSystem._ahud_flowData[0] = 0;
      }
    } else {
...
Actor_Hud.prototype.create_mp_meter = function () {
  ...
  this._mp_meter_red.rotation =
    (Moghunter.ahud_mp_meter_rotation * Math.PI) / 180;
...
Actor_Hud.prototype.update_mp = function () {
  if (this._mp_meter_blue) {
    if (this._mp_flow[0]) {
      ...
      if ($gameSystem._ahud_flowData[1] > this._mp_flow[3]) {
        $gameSystem._ahud_flowData[1] = 0;
      }
    } else {
  ...
  if (this._mp_icons) {
    ...
    if (this._mp_IconZoomAnime) {
      this.updateIconZoomAnime(this._mp_icons);
    }
  }
};
...
Actor_Hud.prototype.create_tp_meter = function () {
  ...
  this._tp_meter_red.rotation =
    (Moghunter.ahud_tp_meter_rotation * Math.PI) / 180;
...
Actor_Hud.prototype.update_tp = function () {
  if (this._tp_meter_blue) {
    if (this._tp_flow[0]) {
      ...
      if ($gameSystem._ahud_flowData[2] > this._tp_flow[3]) {
        $gameSystem._ahud_flowData[2] = 0;
      }
    } else {
  ...
  if (this._tp_icons) {
    ...
    if (this._tp_IconZoomAnime) {
      this.updateIconZoomAnime(this._tp_icons);
    }
  }
};
  ...
  if (this._exp_meter) {
    if (this.need_refresh_parameter(3)) {
      if (this._battler.isMaxLevel()) {
        ...
        this.refresh_meter(
          this._exp_meter,
          this._battler.current_exp_r(),
          this._battler.nextLevelExp_r(),
          0,
          1,
          1
        );
...
Actor_Hud.prototype.create_states = function () {
  if (String(Moghunter.ahud_states_visible) != "true") {
    return;
  }
