...
Moghunter.bhud_com_height = Number(
  Moghunter.parameters["W Command Height"] || 200
);
...
Moghunter.bhud_party_height = Number(
  Moghunter.parameters["W Party Height"] || 0
);
...
Moghunter.bhud_skill_height = Number(
  Moghunter.parameters["W Skill Height"] || 0
);
...
Moghunter.bhud_actor_height = Number(
  Moghunter.parameters["W Actor Height"] || 0
);
...
Moghunter.bhud_enemy_height = Number(
  Moghunter.parameters["W Enemy Height"] || 0
);
...
Spriteset_BattleHudBase.prototype.needResizeScreenLayout = function () {
  ...
  if (!this._screen_layout.resize[0]) {
    return false;
  }
  if (this._screen_layout.resize[1]) {
    return false;
  }
  if (!this._screen_layout.bitmap.isReady()) {
    return false;
  }
  return true;
};
...
Spriteset_BattleHudBase.prototype.resizeScreenLayout = function () {
  if (this._screen_layout.bitmap.width < Graphics.width) {
    this._screen_layout.scale.x =
      Graphics.width / this._screen_layout.bitmap.width;
  }
  if (this._screen_layout.bitmap.height < Graphics.height) {
    this._screen_layout.scale.y =
      Graphics.height / this._screen_layout.bitmap.height;
  }
...
//==============================
Spriteset_BattleHudBase.prototype.createAnimationSprite = function (
  targets,
  animation,
  mirror,
  delay
...
Spriteset_BattleHud.prototype = Object.create(
  Spriteset_BattleHudBase.prototype
);
...
Spriteset_BattleHud.prototype.update = function () {
  ...
  if (this.needResizeScreenLayout()) {
    this.resizeScreenLayout();
  }
};
...
// ♦ ALIAS ♦  onEnemyCancel
//==============================
var _mog_batHud_Scene_Battle_onEnemyCancel =
...
// ♦ ALIAS ♦  onSkillCancel
//==============================
var _mog_batHud_Scene_Battle_onSkillCancel =
...
//==============================
var _mog_batHud_Scene_Battle_endCommandSelection =
...
// ♦ ALIAS ♦  endCommandSelection
//==============================
var _mog_batHud_Scene_Battle_selectPreviousCommand =
...
//==============================
var _mog_batHud_Scene_Battle_startActorCommandSelection =
...
Scene_Battle.prototype.updateStatusWindowVisible = function () {
  this._statusWindow.width = this._statusWindow.active
    ? this._statusWindow.orgSize[0]
    : 0;
};
...
Scene_Battle.prototype.setNewDataAllWindows = function () {
  if (this._actorCommandWindow) {
    this.setNewDataActorCommand();
  }
  if (this._partyCommandWindow) {
    this.setNewDataPartyCommandWindow();
  }
  if (this._helpWindow) {
    this.setNewDataHelpWindow();
  }
  if (this._skillWindow) {
    this.setNewDataSkillWindow();
  }
  if (this._itemWindow) {
    this.setNewDataItemWindow();
  }
  if (this._actorWindow) {
    this.setNewDataActorWindow();
  }
  if (this._enemyWindow) {
    this.setNewDataEnemyWindow();
  }
};
...
Scene_Battle.prototype.updateBattleHud = function () {
  ...
  if (this._statusWindow) {
    this.updateStatusWindowVisible();
  }
  if (this._layoutField) {
    this.updateBhudVisible();
  }
};
...
Scene_Battle.prototype.updateLayoutPosition = function () {
  if (this._com_layout) {
    this.updateCommandWindowLayout();
  }
  if (this._party_layout) {
    this.updatePartyLayout();
  }
  ...
  if (this._actor_layout) {
    this.updateActorLayout();
  }
  if (this._enemy_layout) {
    this.updateEnemyLayout();
  }
};
...
Scene_Battle.prototype.updateCommandWindowLayout = function () {
  this._com_layout.x =
    this._windowLayer.x + Moghunter.bhud_com_lay_x + this._actorCommandWindow.x;
  this._com_layout.y =
    this._windowLayer.y + Moghunter.bhud_com_lay_y + this._actorCommandWindow.y;
...
Scene_Battle.prototype.updatePartyLayout = function () {
  this._party_layout.x =
    this._windowLayer.x +
    Moghunter.bhud_party_lay_x +
    this._partyCommandWindow.x;
  this._party_layout.y =
    this._windowLayer.y +
    Moghunter.bhud_party_lay_y +
    this._partyCommandWindow.y;
...
Scene_Battle.prototype.updateHelpLayout = function () {
  this._help_layout.x =
    this._windowLayer.x + Moghunter.bhud_help_lay_x + this._helpWindow.x;
  this._help_layout.y =
    this._windowLayer.y + Moghunter.bhud_help_lay_y + this._helpWindow.y;
  this._help_layout.visible = this._helpWindow.visible;
  this._help_layout.opacity = this._helpWindow.contentsOpacity;
  if (this.needResizeWindowLayout(this._help_layout)) {
    this.resizeWindowLayout(this._help_layout, this._helpWindow);
  }
};
...
Scene_Battle.prototype.updateSkillLayout = function () {
  this._skill_layout.x =
    this._windowLayer.x + Moghunter.bhud_skill_lay_x + this._skillWindow.x;
  this._skill_layout.y =
    this._windowLayer.y + Moghunter.bhud_skill_lay_y + this._skillWindow.y;
  ...
  if (this.needResizeWindowLayout(this._skill_layout)) {
    this.resizeWindowLayout(this._skill_layout, this._skillWindow);
  }
};
...
Scene_Battle.prototype.updateItemLayout = function () {
  this._item_layout.x =
    this._windowLayer.x + Moghunter.bhud_item_lay_x + this._itemWindow.x;
  this._item_layout.y =
    this._windowLayer.y + Moghunter.bhud_item_lay_y + this._itemWindow.y;
  ...
  if (this.needResizeWindowLayout(this._item_layout)) {
    this.resizeWindowLayout(this._item_layout, this._itemWindow);
  }
};
...
Scene_Battle.prototype.updateActorLayout = function () {
  this._actor_layout.x =
    this._windowLayer.x + Moghunter.bhud_actor_lay_x + this._actorWindow.x;
  this._actor_layout.y =
    this._windowLayer.y + Moghunter.bhud_actor_lay_y + this._actorWindow.y;
  ...
  if (this.needResizeWindowLayout(this._actor_layout)) {
    this.resizeWindowLayout(this._actor_layout, this._actorWindow);
  }
};
...
Scene_Battle.prototype.updateEnemyLayout = function () {
  this._enemy_layout.x =
    this._windowLayer.x + this._enemyWindow.x + Moghunter.bhud_enemy_lay_x;
  this._enemy_layout.y =
    this._windowLayer.y + this._enemyWindow.y + Moghunter.bhud_enemy_lay_y;
  ...
  if (this.needResizeWindowLayout(this._enemy_layout)) {
    this.resizeWindowLayout(this._enemy_layout, this._enemyWindow);
  }
};
...
Scene_Battle.prototype.updateWindowSlideEffect = function () {
  ...
  if (this._enemyWindow.y >= this._enemyWindow.org2[3]) {
    this.updateBHudVFix();
  }
};
  ...
  if ($gameTemp._bhud_position_active) {
    ...
    if ($gameSystem._bhud_auto_com) {
      if (
        ...
        this.yp = $gameTemp._bhud_position_active[1];
        this.org[0] =
          $gameTemp._bhud_position_active[0] + Moghunter.bhud_com_x - this._fx;
        if (this._com_mode === 0) {
          this.org[1] =
            $gameTemp._bhud_position_active[1] +
            Moghunter.bhud_com_y -
